...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"64%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="12">
					<el-form-item label="帖子id" prop="fid">
						<el-input class="list_inp" v-model="form.fid" placeholder="帖子id"
				...
				<el-col :span="12">
					<el-form-item label="发布人" prop="username">
						<el-input class="list_inp" v-model="form.username" placeholder="发布人"
				...
				<el-col :span="12">
					<el-form-item label="头像" prop="avatarurl">
						<el-input class="list_inp" v-model="form.avatarurl" placeholder="头像"
							 type="text" 							:readonly="!isAdd||disabledForm.avatarurl?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="12">
					<el-form-item label="收藏用户id" prop="uid">
						<el-input class="list_inp" v-model="form.uid" placeholder="收藏用户id"
