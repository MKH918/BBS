	...
	<div class="app-contain" :style='{"padding":"10px 0","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">帖子id</div>
					<div  class="info_text" >{{detail.fid}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">发布人</div>
					<div  class="info_text" >{{detail.username}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">头像</div>
					<div  class="info_text" >{{detail.avatarurl}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">收藏用户id</div>
					<div  class="info_text" >{{detail.uid}}</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('forumstore','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('forumstore','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('forumstore','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
