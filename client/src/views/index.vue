<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">基于java的BBS论坛系统</div>
		...
		<el-scrollbar class="contain_view">
			...
			<div class="rotation_view">
				<mySwiper :type="3" :data="rotationList" :autoHeight="false" :autoplay="true"
					:loop="true" :navigation="true" :pagination="true" 
					:paginationType="2" :scrollbar="false" :slidesPerView="1" 
					:spaceBetween="20" :centeredSlides="false"
					:freeMode="false" :effectType="3"
					:direction="horizontal">
					<template #default="scope">
						<img :style='{"width":"100%","height":"500px"}' :src="scope.row.value?$config.url + scope.row.value:''">
					</template>
				</mySwiper>
			</div>
			<router-view />
...
<style lang="scss" scoped>
	...
	.menu_view {
		...
		:deep(.is-active) {
			color: #fff !important;
			background: url(http://clfile.zggen.cn/20231109/ef668850b0314d42bcd82eeda5c325c4.jpg) no-repeat center 56px !important;
